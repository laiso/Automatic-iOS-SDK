...
// AutomaticSDK
#define COCOAPODS_POD_AVAILABLE_AutomaticSDK
#define COCOAPODS_VERSION_MAJOR_AutomaticSDK 0
#define COCOAPODS_VERSION_MINOR_AutomaticSDK 0
#define COCOAPODS_VERSION_PATCH_AutomaticSDK 1
